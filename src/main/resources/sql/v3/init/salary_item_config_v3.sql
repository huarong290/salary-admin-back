INSERT INTO salary_admin_v4.salary_item_config (item_code,item_name,item_category,category_dict_value,env_var_name,default_rule_script,calc_priority,decimal_places,rounding_mode,taxable_flag,tax_deductible_flag,fixed_flag,pinyin_code,sort_value,status,remark,delete_flag,create_by,create_time,update_by,update_time) VALUES
