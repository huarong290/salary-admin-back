INSERT INTO salary_admin_v4.salary_calc_pipeline_step (pipeline_code,pipeline_version,rule_code,rule_name,rule_type,condition_script,stage,sort_order,block_flag,skip_if_null,status,delete_flag,create_by,create_time,update_by,update_time) VALUES
