INSERT INTO salary_calc_rule (rule_code,rule_name,rule_type,rule_script,return_type,sort_value,status,depends_on,param_json,stage,remark,delete_flag,create_by,create_time,update_by,update_time) VALUES
